...
import com.app.cookbook.xinhe.foodfamily.shiyujia.util.StatusbarUtils;
...
public class PersonalHomepageActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarStateChangeListener() {
            ...
            public void onStateChanged(AppBarLayout appBarLayout, State state) {
                if (state == State.EXPANDED) {
                    ...
                    Glide.with(PersonalHomepageActivity.this).load(handPath)
                            .bitmapTransform(new BlurTransformation(PersonalHomepageActivity.this, 60)
                                    , new CenterCrop(PersonalHomepageActivity.this))
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.attention_btn:
                intent = new Intent(PersonalHomepageActivity.this, MyAttentionActivity.class);
                startActivity(intent);
                break;
            case R.id.collect_btn:
                intent = new Intent(PersonalHomepageActivity.this, MyCollectActivity.class);
                startActivity(intent);
                break;
            case R.id.fans_btn:
                intent = new Intent(PersonalHomepageActivity.this, GuanZhuActivity.class);
            ...
            case R.id.compile_tv:
                ...
                StatService.trackCustomKVEvent(PersonalHomepageActivity.this, "Myself_edite_personal_data", prop);
                if ("".equals(SharedPreferencesHelper.get(PersonalHomepageActivity.this, "login_token", ""))) {
                    intent = new Intent(PersonalHomepageActivity.this, LoginActivity.class);
                    startActivity(intent);
                } else {
                    intent = new Intent(PersonalHomepageActivity.this, BianJiActivity.class);
                    startActivity(intent);
                }
                break;
            case R.id.print_btn:
    ...
    private void requestUserMsg(String user_id) {
        ...
        subscription = Network.getInstance("获取好友信息", PersonalHomepageActivity.this)
                .getOtherInformation(params,
                        new ProgressSubscriberNew<>(FriendPage.class, new GsonSubscriberOnNextListener<FriendPage>() {
                            ...
                            public void on_post_entity(FriendPage result) {
                                ...
                                Glide.with(PersonalHomepageActivity.this)
                        ...
                        }, PersonalHomepageActivity.this, false));
    }
...
//        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            StatusBarUtil.setStatusBarColor(PersonalHomepageActivity.this, R.color.white);
        } else {
            StatusBarUtil.transparencyBar(PersonalHomepageActivity.this);
        }
    }
