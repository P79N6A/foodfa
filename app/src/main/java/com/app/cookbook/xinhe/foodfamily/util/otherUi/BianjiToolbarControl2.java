...
public class BianjiToolbarControl2 extends Toolbar {
    ...
    public BianjiToolbarControl2(Context context) {
        super(context);
        init(context, null);
    }

    public BianjiToolbarControl2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        View view = LayoutInflater.from(context).inflate(R.layout.title_relayout_copy2, this, true);
