package com.app.cookbook.xinhe.foodfamily.util.permission;
...
public class PermissionHelper {
    ...
    public static void requestPermisson(Activity activity, int requestCode, String[] permissons) {
        PermissionHelper.with((FragmentActivity) activity).requestCode(requestCode).requestPermission(permissons).request();
    }

    //链式的方式传递
    //传activity
//    public static PermissionHelper with(MineFragment activity) {
