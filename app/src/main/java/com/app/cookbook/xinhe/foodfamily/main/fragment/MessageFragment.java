...
public class MessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_message_fragment, null);
        ...
        no_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
                    ...
                    SharedPreferencesHelper.put(getActivity(), "ColseTime", strtime);
        ...
        xiaoxi_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StatService.trackCustomKVEvent(getActivity(), "News_pay_attention_me_problem", prop2);
                if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
                    Intent intent = new Intent(getActivity(), LoginActivity.class);
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(getActivity(), GuanZhuAndQuestionActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        nicheng_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StatService.trackCustomKVEvent(getActivity(), "News_praise_collection", prop2);
                if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
                    Intent intent = new Intent(getActivity(), LoginActivity.class);
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(getActivity(), DianZanActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        pinglun_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StatService.trackCustomKVEvent(getActivity(), "News_comment", prop2);
                if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
                    Intent intent = new Intent(getActivity(), LoginActivity.class);
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(getActivity(), MessageCommentActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        touxiang_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StatService.trackCustomKVEvent(getActivity(), "News_laster_answer", prop2);
                if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
                    Intent intent = new Intent(getActivity(), LoginActivity.class);
                    startActivity(intent);
                } else {
        ...
        zhiye_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StatService.trackCustomKVEvent(getActivity(), "News_system_notification", prop2);
                if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
                    Intent intent = new Intent(getActivity(), LoginActivity.class);
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(getActivity(), XiTongLocationActivity.class);
                    startActivity(intent);
                }
            }
        });
...
//                                Log.e("123","消息页面获取到消息数量：");
    ...
    public void onResume() {
        ...
        if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
            ...
            initDate(false);
            //判断通知是否打开
            if (isNotificationEnabled(getActivity()) == true) {
                open_mes.setVisibility(View.GONE);
            } else {
                open_mes.setVisibility(View.VISIBLE);
                String time = SharedPreferencesHelper.get(getActivity(), "ColseTime", "").toString();
    ...
    public void onDestroyView() {
        super.onDestroyView();
        //Log.e("精神科附近考虑到是否", "sjfksjdklfjksd");
        if (null != mHandler) {
            mHandler.removeCallbacks(mRegularAction);   //把runable移除队列
            mHandler = null;
        }
    ...
    private void initDate(boolean is_show) {
        subscription = Network.getInstance("消息页面获取通知界面", getActivity())
                .get_location_shouye(
                        new ProgressSubscriberNew<>(Location.class, new GsonSubscriberOnNextListener<Location>() {
                            @Override
    ...
    Handler handlerStart = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //判断自启动权限
            PopWindowHelper.public_tishi_pop(getActivity(), "食与家提示", "是否设置后台接受推送？", "取消", "设置", new DialogCallBack() {
                @Override
                public void save() {
//                    openStart(getActivity());
                    toSetting();
                }
