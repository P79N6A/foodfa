...
public class FastBlurUtil {
    ...
    public static Bitmap GetUrlBitmap(String url, int scaleRatio) {
        ...
        try {
            ...
            int oragWidth = 0;
            if(0!=originBitmap.getWidth()){
                oragWidth = originBitmap.getWidth();
            }else{
                oragWidth=100;
            }
            int oragHight = 0;
            if(0!=originBitmap.getHeight()){
                oragHight = originBitmap.getHeight();
            }else{
                oragHight = 100;
            }
            scaledBitmap = Bitmap.createScaledBitmap(originBitmap,
                    oragWidth / scaleRatio,
                    oragHight / scaleRatio,
                    false);
