...
public class LabelPrintAdapter extends RecyclerView.Adapter<LabelPrintAdapter.Holder> {

    private Context context;
    private LayoutInflater inflater;
    private List<LabelPrint.DataBean> homeItems;
    ...
    Activity activity;
    //是否点击播放
    private boolean isClie;


    public LabelPrintAdapter(Context context, Handler handler) {
        this.context = context;
        this.handler = handler;
        this.inflater = LayoutInflater.from(context);
    }

    public void setHomeItems(List<LabelPrint.DataBean> homeItems) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 1:
                holder = new VideoHolder(inflater.inflate(R.layout.label_print_item, parent, false));
                break;
            case 2:
    ...
    public abstract class Holder extends RecyclerView.ViewHolder {
        ...
        public TextView tv;
        public TextView recommend_label_tv;
        ...
        public abstract void bindHolder(LabelPrint.DataBean data, int position);
    }

    //图文自布局
    public class ImageTextHolder extends LabelPrintAdapter.Holder {
        ...
        public ImageTextHolder(View itemView) {
            ...
            recommend_label_tv = itemView.findViewById(R.id.recommend_label_tv);
        }


        @Override
        public void bindHolder(final LabelPrint.DataBean data, final int position) {
            ...
            if ("1".equals(data.getIs_recommend_class())) {
                recommend_label_tv.setVisibility(View.VISIBLE);
            } else {
                recommend_label_tv.setVisibility(View.GONE);
            }
            if ("1".equals(data.getIs_thumbs())) {
                like_btn.setLiked(true);
                like_btn.setLikeDrawableRes(R.drawable.home_like_on);
            } else if ("2".equals(data.getIs_thumbs())) {
            ...
            } else if ("2".equals(data.getIs_collect())) {
                ...
                public void onClick(View v) {
                    ...
                    if ("1".equals(data.getIs_thumbs())) {
                        if ("".equals(SharedPreferencesHelper.get(context, "login_token", ""))) {
                            ...
                            homeItems.get(position).setIs_thumbs("2");
                            zan_layout.setText(data.getThumb_number() + "点赞 ");
                            like_btn.setLiked(false);
                            like_btn.setUnlikeDrawableRes(R.drawable.home_like_off);
                        }
                        ...
                        if ("".equals(SharedPreferencesHelper.get(context, "login_token", ""))) {
                            ...
                            int comment_number = Integer.valueOf(data.getThumb_number());
                            data.setThumb_number(String.valueOf(comment_number + 1));
                            homeItems.get(position).setIs_thumbs("1");
                            zan_layout.setText(data.getThumb_number() + "点赞 ");
                            like_btn.setLiked(true);
                            like_btn.setLikeDrawableRes(R.drawable.home_like_on);
                        }
                ...
                public void onClick(View v) {
                    ...
                    if ("1".equals(data.getIs_collect())) {
                        if ("".equals(SharedPreferencesHelper.get(context, "login_token", ""))) {
                            ...
                            homeItems.get(position).setIs_collect("2");
                            coll_layout.setText(data.getCollection_number() + "收藏");
                            collect_btn.setLiked(false);
                            collect_btn.setUnlikeDrawableRes(R.drawable.home_collect_off);
                        }
                        ...
                        if ("".equals(SharedPreferencesHelper.get(context, "login_token", ""))) {
                            ...
                            int Collection_number = Integer.valueOf(data.getCollection_number());
                            data.setCollection_number(String.valueOf(Collection_number + 1));
                            homeItems.get(position).setIs_collect("1");
                            coll_layout.setText(data.getCollection_number() + "收藏");
                            collect_btn.setLiked(true);
                            collect_btn.setLikeDrawableRes(R.drawable.home_collect_on);
                        }
                        ...
                        runnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                if ("".equals(SharedPreferencesHelper.get(context, "login_token", ""))) {
                                    ...
                                    if (!"1".equals(homeItems.get(position).getIs_thumbs())) {
                                        int comment_number = Integer.valueOf(data.getThumb_number());
                                        data.setThumb_number(String.valueOf(comment_number + 1));
                                        homeItems.get(position).setIs_thumbs("1");
                                        zan_layout.setText(data.getThumb_number() + "点赞 ");
    ...
    //视频子布局
    public class VideoHolder extends LabelPrintAdapter.Holder {
...
//                    Log.e("123", "   urlTail   " + urlMiddle + "-" + newTime + "-0-0-SHoXEVJALKeRij7JBnLgAIEDMPPKwgL2");
                ...
                if ("1".equals(Contacts.isVideoPlay)) {
                    if (Contacts.isPlay == true) {
                        ...
                        if (Contacts.isPlay == true) {
                            if (Contacts.currPosition != 0 && Contacts.currItem == position) {
