...
public class MyFollowerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void steepStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            StatusBarUtil.setStatusBarColor(MyFollowerActivity.this, R.color.white);
        } else {
            StatusBarUtil.transparencyBar(MyFollowerActivity.this);
        }
    }
    ...
    private void getItemClick() {
        myAttentionUserAdapter.setOnItemClickListener(new MyAttentionUserAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(MyFollowerActivity.this, FriendPageActivity.class);
    ...
    private void set_list_resource(final List<WoGuanZhuEntity.DataBean> dates) {
        ...
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        myAttentionUserAdapter = new MyAttentionUserAdapter(MyFollowerActivity.this);
