 ...
 */
package com.app.cookbook.xinhe.foodfamily.util.matisse.filter;

import android.content.Context;

import com.app.cookbook.xinhe.foodfamily.util.matisse.MimeType;
import com.app.cookbook.xinhe.foodfamily.util.matisse.SelectionCreator;
...
public abstract class Filter {
    /**
     * Convenient constant for a minimum value.5.00
     */
