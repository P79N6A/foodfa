...
public class WoDeTiWenActivity extends BaseActivity {
    ...
    TextView title_two;
    private MyTiWenAdapter tiWenAdapter;
    private int PAGE = 1;
    ...
    public void initView() {
        setContentLayout(R.layout.activity_wo_de_ti_wen);
        //初始化黄牛刀
    ...
    private void getItemClick() {
        tiWenAdapter.setOnItemClickListener(new MyTiWenAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(WoDeTiWenActivity.this, FenLeiQuestionDetailActivity.class);
    ...
    private void init_net_source(boolean is_show_dialog) {
        subscription = Network.getInstance("获取提问", this)
    ...
    private void set_list_resource(final List<TiWenEntity> dates) {
        ...
        tiWenAdapter.setTitleName("我的提问");
