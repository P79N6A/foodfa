...
public class ImageTextCommentAdapter extends RecyclerView.Adapter<ImageTextCommentAdapter.Holder> {
    ...
    private List<ImageTextDetails.ClassDataBean> class_data;
    private List<String> imageList;


    public ImageTextCommentAdapter(Context context, Handler handler) {
    ...
    public List<ImageTextDetails.ClassDataBean> getClass_data() {
        return class_data;
    }

    public void setClass_data(List<ImageTextDetails.ClassDataBean> class_data) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Holder holder = new Holder(inflater.inflate(R.layout.image_text_comment_item, parent, false));
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull final Holder holder, final int position) {
        ...
        if (position == 0) {
            holder.imageText_msg_layout.setVisibility(View.VISIBLE);
            ...
            RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) holder.home_details_kanner.getLayoutParams();
            lp.height = width;
            holder.home_details_kanner.setLayoutParams(lp);
            ...
            holder.home_details_kanner.setImages(imageList)
                    .setBannerTitles(null)
                    .setImageLoader(new GlideImageLoader())
                    .start();
            holder.home_details_kanner.updateBannerStyle(BannerConfig.NUM_INDICATOR);
            ...
            Glide.with(context)
                    ...
                    .into(holder.writer_user_head);
            holder.writer_user_name.setText(name);
            ...
            if (class_data != null) {
                ...
                holder.labels.setLabels(class_data, new LabelsView.LabelTextProvider<ImageTextDetails.ClassDataBean>() {
                    @Override
                ...
                holder.labels.setOnLabelClickListener(new LabelsView.OnLabelClickListener() {
                    ...
                    public void onLabelClick(TextView label, Object data, int position) {
                        ImageTextDetails.ClassDataBean item = class_data.get(position);
            ...
            if (dataBean != null && dataBean.getUser_data() != null) {
                ...
                if (dataBean.getUser_data().getAvatar() != null) {
                    Glide.with(context)
            ...
            holder.home_details_kanner.setOnBannerListener(new OnBannerListener() {
                @Override
...
//                        intent.putExtra("curImageUrl", dataBean.getUser_data().getAvatar());
            ...
            holder.imageText_msg_layout.setVisibility(View.GONE);
            holder.empty_layout.setVisibility(View.GONE);
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        private CircleImageView writer_user_head;
        private TextView writer_user_name;
        ...
        public Holder(View itemView) {
            ...
            imageText_msg_layout = itemView.findViewById(R.id.imageText_msg_layout);
            home_details_kanner = itemView.findViewById(R.id.home_details_kanner);
            user_msg_layout = itemView.findViewById(R.id.user_msg_layout);
            writer_user_head = itemView.findViewById(R.id.writer_user_head);
            writer_user_name = itemView.findViewById(R.id.writer_user_name);
