package com.app.cookbook.xinhe.foodfamily.util.timePackDemo;
...
import com.app.cookbook.xinhe.foodfamily.util.timePackDemo.wheelview.OnWheelChangedListener;
import com.app.cookbook.xinhe.foodfamily.util.timePackDemo.wheelview.OnWheelScrollListener;
import com.app.cookbook.xinhe.foodfamily.util.timePackDemo.wheelview.WheelView;
import com.app.cookbook.xinhe.foodfamily.util.timePackDemo.wheelview.adapter.AbstractWheelTextAdapter1;
...
//		this.setAnimationStyle(R.style.AnimBottom);
		...
		wvYear.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				Log.e("123","sdfsfddddddsfs"+currentYear);
	...
	public void onClick(View v) {
		...
		if (v == btnSure) {
			if (onBirthListener != null) {
				...
				Log.d("自己选择的日期",""+selectYear+""+selectMonth+""+selectDay);
			}
		} else if (v == btnSure) {
