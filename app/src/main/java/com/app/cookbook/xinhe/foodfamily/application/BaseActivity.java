...
public abstract class BaseActivity extends SuperActivity implements View.OnClickListener, EasyPermissions.PermissionCallbacks {
    ...
    protected static int reSting = hei.permission.R.string.ask_again;//默认提示语句
    ...
    public void onPermissionsDenied(int requestCode, List<String> perms) {
        ...
        EasyPermissions.checkDeniedPermissionsNeverAskAgain(this,
                getString(hei.permission.R.string.perm_tip),
                hei.permission.R.string.setting, hei.permission.R.string.cancel, null, perms);
    }
}
