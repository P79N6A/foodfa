 ...
 */
package com.app.cookbook.xinhe.foodfamily.util.matisse.internal.ui.adapter;
...
import com.app.cookbook.xinhe.foodfamily.util.matisse.internal.ui.widget.CheckView;
import com.app.cookbook.xinhe.foodfamily.util.matisse.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            Log.e("进来了第一张相机图片", "进来了第一张相机图片" + drawables.length);
            ...
            Log.e("进来了相机图片", "进来了相机图片" + item.getContentUri());

           /*if (SDCardUtil.isImage(SDCardUtil.getFilePathByUri(mContext, item.getContentUri()))) {

            } else {
                SDCardUtil.getFilePathByUri(mContext, item.getContentUri());
                File file = new File(SDCardUtil.getFilePathByUri(mContext,item.getContentUri()));
                SDCardUtil.deleteFile(file.getPath());
                Log.e("破损了", "破损了" + item.getContentUri());
            }*/
        }
    }
