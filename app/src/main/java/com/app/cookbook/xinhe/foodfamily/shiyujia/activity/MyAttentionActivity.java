...
public class MyAttentionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        fragmentList.add(new MyAttentionUserFragment());
        fragmentList.add(new MyAttentionIssueFragment());
        fragmentList.add(new MyAttentionLabelFragment());
    ...
    private void steepStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            StatusBarUtil.setStatusBarColor(MyAttentionActivity.this, R.color.white);
        } else {
            StatusBarUtil.transparencyBar(MyAttentionActivity.this);
        }
    }
