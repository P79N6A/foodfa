package com.app.cookbook.xinhe.foodfamily.main.db;
...
public class NoteDao {
     ...
     * 查询单个笔记
     */
    public Note queryNoteOne(int groupId) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                note.setMcontent(cursor.getString(cursor.getColumnIndex("n_mcontent")));
    ...
    public long insertNote(Note note) {
        SQLiteDatabase db = helper.getWritableDatabase();
        String sql = "insert into db_note(n_title,n_content,n_mcontent,n_group_id,n_group_name," +
        ...
        try {
            ...
            stat.bindString(3, note.getMcontent());
            ...
            stat.bindString(9, note.getCreateTime());
            stat.bindString(10, DateUtils.date2string(new Date()));
    ...
    public void updateNote(Note note) {
        ...
        values.put("n_mcontent", note.getMcontent());
