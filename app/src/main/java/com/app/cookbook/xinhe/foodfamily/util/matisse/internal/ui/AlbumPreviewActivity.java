...
public class AlbumPreviewActivity extends BasePreviewActivity implements
    ...
    public void onAlbumMediaLoad(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            if(SDCardUtil.isImage(SDCardUtil.getFilePathByUri(AlbumPreviewActivity.this,item.getContentUri()))){
                Log.e("加载格式正确的图片",Item.valueOf(cursor).getContentUri().getPath());
                items.add(Item.valueOf(cursor));
            }else{
                Log.e("图片已损坏不加载","图片已损坏");
            }
        }
