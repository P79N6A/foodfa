package com.app.cookbook.xinhe.foodfamily.util.snackbar;
...
public final class TopSnackBar extends BaseTransientBottomBar<TopSnackBar> {
    ...
    public static TopSnackBar make(@NonNull View view, @NonNull CharSequence text,
                                   @Duration int duration, Context context) {
        ...
        TextView message = (TextView) content.findViewById(R.id.snackbar_text);
        Drawable drawableRight = null;
        drawableRight = context.getResources().getDrawable(R.drawable.icon_shart_ok);
        drawableRight.setBounds(0, 0, 50, 50);
        message.setCompoundDrawables(drawableRight, null, null, null);
     ...
     */
    @NonNull
    public static TopSnackBar make(@NonNull View view, @StringRes int resId, @Duration int duration, Context context) {
        return make(view, view.getResources().getText(resId), duration, context);
    }
