...
import com.app.cookbook.xinhe.foodfamily.shiyujia.adapter.NewIssueAdapter;
...
public class IssueFragment extends ViewPagerFragment {
    ...
    private NewIssueAdapter newIssueAdapter;
    private LinearLayoutManager layoutManager;
    private List<NewHandpick.DataBean> searchEns = new ArrayList<>();
    /**
     * Rxjava
     */
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            NewHandpick.DataBean dataBean = searchEns.get(msg.arg1);
            switch (msg.what) {
                case 400:
    ...
    private void initJingXuanDate(boolean is_show_dialog) {
        subscription = Network.getInstance("获取精选列表", getActivity())
                .get_question_list(String.valueOf(PAGE),
                        new ProgressSubscriberNew<>(NewHandpick.class, new GsonSubscriberOnNextListener<NewHandpick>() {
                            @Override
                            public void on_post_entity(NewHandpick result) {
...
//                                Log.e("123", "     获取精选列表成功      ");
    ...
    private void init_new_source(List<NewHandpick.DataBean> searchEns) {
        //设置上拉刷新下拉加载
        ...
        newIssueAdapter = new NewIssueAdapter(searchEns, getActivity(), true, handler);
