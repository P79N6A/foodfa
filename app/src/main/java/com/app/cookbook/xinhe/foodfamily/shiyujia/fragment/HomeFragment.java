    ...
    private void initView() {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (firstVisibleItem == 0 && homeItems.get(getCurrentViewIndex()).getStatus() == 1) {
...
//                                Log.e("123","      --->    ");
                                ...
                                if (lastVisibleItem == getCurrentViewIndex() ||
                                        lastVisibleItem - getCurrentViewIndex() == 1 && getCurrentViewIndex() - firstVisibleItem == 1) {
//                                    Log.e("123","      +++>    ");
                                    Contacts.isVideoPlay = "1";
                                    homeAdapter.notifyDataSetChanged();
                                }
    ...
    public void onEvent(MessageEvent messageEvent) {
        ...
        switch (messageEvent.getMessage()) {
            case "122":
                ...
                TopSnackBar.make(search_btn, "分享成功", BaseTransientBottomBar.LENGTH_SHORT, getActivity()).show();
                ...
                if ("".equals(SharedPreferencesHelper.get(getActivity(), "login_token", ""))) {
                    ...
                    if (homeItems.get(pos).getStatus() == 1) {
                        if ("2".equals(homeItems.get(pos).getIs_thumbs())) {
                            VideoDianZanNet(homeItems.get(pos).getId(), "1");
                        }
                    } else {
                        if ("2".equals(homeItems.get(pos).getIs_thumbs())) {
                            DianZanNet(homeItems.get(pos).getId(), "2");
                        }
                    }
                }
                break;
    ...
    private void initJingXuanDate(boolean is_show_dialog) {
        subscription = Network.getInstance("首页", getActivity())
                .get_home(String.valueOf(PAGE),
...
//                                homeAdapter.notifyDataSetChanged();
    ...
    private void set_list_resource(final List<HomeItem.DataBean> dates) {
        ...
        recyclerView.setLayoutManager(layoutManager);
        homeAdapter = new HomeAdapter(getActivity(), handler);
        homeAdapter.setHomeItems(dates);
        homeAdapter.setImageList(imageList);
        recyclerView.setAdapter(homeAdapter);
        recyclerView.setHasFixedSize(true);
        if ("0".equals(SharedPreferencesHelper.get(getActivity(), "isHomeMsg", ""))) {
            SharedPreferencesHelper.put(getActivity(), "isHomeMsg", "1");
        }
        // 设置静默加载模式
        // 设置静默加载模式
                ...
                .get_location_shouye(
                        new ProgressSubscriberNew<>(Location.class, new GsonSubscriberOnNextListener<Location>() {
                            ...
                            public void on_post_entity(Location location) {
                                ...
                                int e = a + b + c + d + f;
                                if (e > 0) {
                                    mesg_hint.setVisibility(View.VISIBLE);
                                } else {
                                    mesg_hint.setVisibility(View.GONE);
                                }
    ...
    private void select_more_popwindow(HomeItem.DataBean dataItem, int type) {
        ...
        //编辑
        if (functionListem.size() == 0) {
            Log.e("123", "     " + SharedPreferencesHelper.get(getActivity(), "user_id", "") + "     " + Uid);
            Log.e("123", "     " + dataItem.getStatus());
                    ...
                    case "微信":
                        ...
                        if (type == 1) {
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getVideo_data().getFace_path())) {
                                    ShareUtil.ShareWechat(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                                            dataItem.getVideo_data().getFace_path(),
                                            Network.VideoUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareWechat(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                    ...
                    case "朋友圈":
                        ...
                        if (type == 1) {
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getVideo_data().getFace_path())) {
                                    ShareUtil.ShareWechatMoments(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                                            dataItem.getVideo_data().getFace_path(),
                                            Network.VideoUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareWechatMoments(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                if (!TextUtils.isEmpty(dataItem.getImage_data().get(0).getPath())) {
                                    ShareUtil.ShareWechatMoments(getActivity(), dataItem.getUser_data().getName() + "发布了图文", dataItem.getContent(),
                                            dataItem.getImage_data().get(0).getPath(),
                                            Network.ImageTextUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareWechatMoments(getActivity(), dataItem.getUser_data().getName() + "发布了图文", dataItem.getContent(),
                                ...
                                if (!TextUtils.isEmpty(dataItem.getImage_data().get(0).getPath())) {
                                    ShareUtil.ShareWechatMoments(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
                                            dataItem.getImage_data().get(0).getPath(),
                                            Network.ImageTextUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareWechatMoments(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
                    ...
                    case "新浪微博":
                        ...
                        if (type == 1) {
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getVideo_data().getFace_path())) {
                                    ShareUtil.ShareWeiBo(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                                            dataItem.getVideo_data().getFace_path(),
                                            Network.VideoUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareWeiBo(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getImage_data().get(0).getPath())) {
                                    ShareUtil.ShareWeiBo(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
                                            dataItem.getImage_data().get(0).getPath(),
                                            Network.ImageTextUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareWeiBo(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
                    ...
                    case "QQ":
                        ...
                        if (type == 1) {
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getVideo_data().getFace_path())) {
                                    ShareUtil.ShareQQ(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                                            dataItem.getVideo_data().getFace_path(),
                                            Network.VideoUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareQQ(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getImage_data().get(0).getPath())) {
                                    ShareUtil.ShareQQ(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
                                            dataItem.getImage_data().get(0).getPath(),
                                            Network.ImageTextUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareQQ(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
                    ...
                    case "QQ空间":
                        ...
                        if (type == 1) {
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getVideo_data().getFace_path())) {
                                    ShareUtil.ShareQZone(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                                            dataItem.getVideo_data().getFace_path(),
                                            Network.VideoUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareQZone(getActivity(), dataItem.getUser_data().getName() + "发布了视频", "暂无介绍",
                            ...
                            if (!TextUtils.isEmpty(dataItem.getContent())) {
                                ...
                                if (!TextUtils.isEmpty(dataItem.getImage_data().get(0).getPath())) {
                                    ShareUtil.ShareQZone(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
                                            dataItem.getImage_data().get(0).getPath(),
                                            Network.ImageTextUrl + dataItem.getId(), "2");
                                } else {
                                    ShareUtil.ShareQZone(getActivity(), dataItem.getUser_data().getName() + "发布了图文", "暂无介绍",
...
//                                Toast.makeText(getApplicationContext(), error, Toast.LENGTH_SHORT).show();
    ...
    public void onResume() {
        super.onResume();
        if ("0".equals(Contacts.selectTab)) {
