...
import com.app.cookbook.xinhe.foodfamily.shiyujia.fragment.MyDraftsPrintFragment;
...
public class MyDraftsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        title_tv.setText("草稿箱");
        ArrayList<String> titleDatas = new ArrayList<>();
        titleDatas.add("印迹");
        titleDatas.add("回答");
        titleDatas.add("提问");
        ArrayList<Fragment> fragmentList = new ArrayList<Fragment>();
        fragmentList.add(new MyDraftsPrintFragment());
        fragmentList.add(new DraftAnswerFragment());
        fragmentList.add(new DraftQuestionFragment());
    ...
    private void steepStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            StatusBarUtil.setStatusBarColor(MyDraftsActivity.this, R.color.white);
        } else {
            StatusBarUtil.transparencyBar(MyDraftsActivity.this);
        }
    }
}
