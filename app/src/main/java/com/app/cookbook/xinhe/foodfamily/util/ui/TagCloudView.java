...
public class TagCloudView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_COLOR = Color.parseColor("#777777");
    ...
    private static int DEFAULT_VIEW_BORDER = 25;
    private static final int DEFAULT_TEXT_BORDER_HORIZONTAL = 0;
    private static int DEFAULT_TEXT_BORDER_VERTICAL = 25;
    ...
    public TagCloudView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        DEFAULT_VIEW_BORDER = ScreenUtilsHelper.dip2px(context,10);
        DEFAULT_TEXT_BORDER_VERTICAL = ScreenUtilsHelper.dip2px(context,10);
