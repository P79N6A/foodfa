...
public class StringUtils {
    ...
    public static String stringFilterTwo(String str) throws PatternSyntaxException {
        str = str.replace("</p><p>", "\n");
        str = str.replace("<p>", "");
        str = str.replace("<br/>", "\n");
        str = str.replace("</p>", "");
     ...
     * @return
     */
    public static List<Label.DataBean> removeDuplicate(List<Label.DataBean> list) {
        Set set = new LinkedHashSet<Label.DataBean>();
        set.addAll(list);
        list.clear();
        list.addAll(set);
        return list;
