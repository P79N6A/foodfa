...
public class MyAttentionIssueAdapter extends BaseRecyclerAdapter<RecyclerView.ViewHolder> {
    private List<MineGuanZhuQuestionEntity.DataBean> list;
    private Context context;
    private static final int EMPTY_VIEW = 2;
    private static final int TYPE_ITEM = 1;

    public MyAttentionIssueAdapter(Context mcontext) {
        context = mcontext;
    }

    public void setList(List<MineGuanZhuQuestionEntity.DataBean> list) {
        this.list = list;
    }
    ...
    private RecyclerView.ViewHolder getViewHolderByViewType(int viewType, ViewGroup parent) {
        View empty_view = LayoutInflater.from(context).inflate(R.layout.mine_guanzhuwenti_empty_layout, parent, false);
