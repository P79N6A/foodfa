...
public class AliyunVideoRecorder extends Activity implements View.OnClickListener, View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener, GestureDetector.OnGestureListener {
    ...
    public static void startRecordForResult(Activity activity,int requestCode,AliyunSnapVideoParam param,boolean mis_first){
        is_first = mis_first;
...
//    }
    ...
    private void initView() {
        fuceng = (LinearLayout) findViewById(R.id.fuceng);
        if(is_first){
