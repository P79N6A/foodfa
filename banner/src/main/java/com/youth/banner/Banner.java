...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorUnselectedResId = R.drawable.huidian_radius;
    ...
    public Banner(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorSize = dm.widthPixels / 110;
        indicatorSize2 = dm.widthPixels / 90;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.huidian_radius);
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void setOnPageChangeListeners(OnPageChangeListener onPageChangeListener) {
