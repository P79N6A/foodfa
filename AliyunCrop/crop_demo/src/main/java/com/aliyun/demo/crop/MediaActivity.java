...
public class MediaActivity extends Activity implements View.OnClickListener{
    ...
    private void getData(){
        ...
        minVideoDuration = getIntent().getIntExtra("3000",3000);
        maxVideoDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MAX_VIDEO_DURATION,10 * 60 *1000);
        minCropDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_CROP_DURATION,3000);
        ...
        minDuration = getIntent().getIntExtra("3000",3000);
    ...
    private void init(){
        ...
        galleryMediaChooser = new GalleryMediaChooser(this,galleryView,galleryDirChooser,storage,thumbnailGenerator,needRecord);
