...
//        }
    ...
    private void getData() {
        ...
        cropDuration = getIntent().getIntExtra("3000", 3000);
    ...
    public void seekBarValueChanged(float leftThumb, float rightThumb, int whitchSide) {
        ...
        min_value = (float) (mEndTime - mStartTime) / 1000;
        if(mPlayer != null){
    ...
    public void onClick(View v) {
        if (v == transFormBtn) {
            ...
            if(min_value>=3){
                ...
                Toast.makeText(getApplicationContext(),"视频不能少于3秒",Toast.LENGTH_SHORT).show();
            }
